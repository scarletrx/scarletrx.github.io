// Generated on 2014-02-16 using generator-jekyllrb 1.2.1
'use strict';
// Directory reference:
//   css: css
//   compass: _scss
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {},
    uglify: {},
    cssmin: { dist: { options: { check: 'gzip' } } },
    imagemin: {
      dist: {
    ...
    buildcontrol: {
      dist: {
        options: {
          remote: 'https://github.com/scarletrx/scarletrx.github.io.git',
          branch: 'master',
          commit: true,
          push: true
        }
